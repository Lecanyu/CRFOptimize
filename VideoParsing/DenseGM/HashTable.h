...
#ifndef VIDEOPARSING_DENSEGM_HASHTABLE_H_
#define VIDEOPARSING_DENSEGM_HASHTABLE_H_
...
class HashTable {
 ...
 public:
  explicit HashTable(size_type n_elements)
      : filled_(0),
...
#endif /* VIDEOPARSING_DENSEGM_HASHTABLE_H_ */
