/**
 * @file PartialParallelPermutohedralLattice.h
 * @brief PartialParallelPermutohedralLattice
 *
 * @author Abhijit Kundu
 */

#ifndef VIDEOPARSING_DENSEGM_PARTIALPARALLEL_PERMUTOHEDRAL_LATTICE_H_
#define VIDEOPARSING_DENSEGM_PARTIALPARALLEL_PERMUTOHEDRAL_LATTICE_H_
...
template <int D>
class PartialParallelPermutohedralLattice {
  struct Neighbors {
    int n1, n2;
 ...
 public:
  ...
  PartialParallelPermutohedralLattice(const Eigen::MatrixBase<Derived>& feature, std::size_t num_of_lattice_points = 0)
    : N_(feature.cols()),
      offset_(D + 1 , N_),
      barycentric_(D + 1 , N_) {
...
#endif /* GRAPHMODEL_DENSECRF_PARTIALPARALLEL_PERMUTOHEDRAL_LATTICE_H_ */
